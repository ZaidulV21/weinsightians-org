...
const ServicePage1 = () => {
  return (
    <>
      {/* section1 */}
      <div className='h-screen px-16 p-5'>
        <Navbar />
        ...
        <div className='absolute bottom-10 flex justify-between w-[90%]'>
          ...
          <img className='rotate36 h-28' src="/img/64bbbf416decd23360ebb88c_get-in-touch-badge.svg" alt="getintotouch" />
        </div>
      </div>
      {/* section2 */}
      <div className='h-full w-full px-16 relative'>
        <div className='flex mt-28 justify-between items-center font-[gilroy]'>
          <div className='relative'>
            ...
            <h1 className=' text-5xl'>From concept to execution our  <br />services are designed to set you apart</h1>
          </div>
          <div className='relative'>
            <h1 className=''>Start your project with us today</h1>
            <div className='absolute left-0 w-20 h-[2px] bg-zinc-500 transition-all duration-500 hover:w-full'></div>
          </div>
        </div>
        <div className='w-full mt-28 h-[2px] bg-zinc-500 '></div>
        {/* Services  */}
        {/* <OurServices /> */}
        <OurServices2/>
        <Footer/>
