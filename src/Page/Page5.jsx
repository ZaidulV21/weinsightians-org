  ...
  return (
    <div className=' bg-white px-16'>
      ...
      <div className='flex justify-between mt-28 -mb-2'>
        <h1 className='w-1/2 font-[gilroy]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti quo reprehenderit rem rerum suscipit. Nam quidem consectetur, similique porro fugit repudiandae .</h1>
