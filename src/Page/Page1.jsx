...
const Page1 = () => {
  return (
    <div className=" bg-custom text-black px-16 h-screen p-5">
      <Navbar />
      <div className='uppercase text-6xl mt-16 font-semibold font-[gilroy] '>
        <h1>bring all your</h1>
        <h1>ideas to life with our</h1>
        <h1>creative magic</h1>
      </div>
      <div className='mt-6 font-thin text-xl'>
      ...
      <div className='flex mt-10'>
        <button className='px-10 py-2 text-[#231746] font-thin transition-transform-all duration-500 rounded-full border-2 bg-[#fff] hover:bg-[#534277] '>Get Started</button>
